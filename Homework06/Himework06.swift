...
//a) Cтруктура работника пиццерии:
...
//b) Добавление массива с работниками в класс пиццерии:
...
//количество мест и функция, которая на вход принимает количество гостей, которое хотят
